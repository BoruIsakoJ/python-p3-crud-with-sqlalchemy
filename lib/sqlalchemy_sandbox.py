...
#Ordering - sort in ascending order
...
#Ordering - sort in descending order    
...
#Limiting -To limit your result set to the first x records
...
#func- Importing func from sqlalchemy gives us access to common SQL operations through functions like sum() and count()
